...
#define ODM_N_ANTDIV_SUPPORT		(ODM_RTL8188F)
#define ODM_ANTDIV_SUPPORT		(ODM_N_ANTDIV_SUPPORT)
#define ODM_SMART_ANT_SUPPORT		0
#define ODM_HL_SMART_ANT_TYPE1_SUPPORT	0

#define ODM_ANTDIV_2G_SUPPORT_IC	(ODM_RTL8188F)
#define ODM_ANTDIV_5G_SUPPORT_IC	0

#define ODM_EVM_ENHANCE_ANTDIV_SUPPORT_IC	0
